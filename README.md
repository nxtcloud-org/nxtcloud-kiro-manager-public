...
| 메인 대시보드 | 주간 AI 인사이트 |
|---|---|
| ![Dashboard](./docs/screenshots/01-dashboard.png) | ![Weekly Insight](./docs/screenshots/02-weekly-insight.png) |
| **AI 분석 리포트** | **사용량 트렌드** |
| ![AI Analysis](./docs/screenshots/03-ai-analysis.png) | ![Usage Trend](./docs/screenshots/04-usage-trend.png) |

> 모든 화면은 운영 환경 스크린샷이며, 학생/사용자 식별 정보는 익명화 처리되었습니다.
